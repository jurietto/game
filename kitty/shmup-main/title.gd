...
func _process(delta: float) -> void:
	match state:
		MenuState.MAIN:
			_update_main_menu_input(delta)
		MenuState.INSTRUCTIONS:
			_update_instructions_input(delta)


func _update_main_menu_input(_delta: float) -> void:
	# Move selection
...
func _update_instructions_input(_delta: float) -> void:
